...
> Looking for the day-to-day development workflow (setup, `make` targets, local frontend, coding conventions)?
> See [docs/getting-started/CONTRIBUTING.md](docs/getting-started/CONTRIBUTING.md).
...
3. Ensure local tests pass (`make validate`).
