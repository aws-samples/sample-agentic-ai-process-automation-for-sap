...
**💡 Example:** See this approach implemented in `agentcore/agent/basic_agent.py`
...
**💡 Example:** See the [LangChain AWS Integration samples](https://github.com/langchain-ai/langchain-aws/tree/main/samples/memory) for working LangGraph + AgentCore Memory store code.
