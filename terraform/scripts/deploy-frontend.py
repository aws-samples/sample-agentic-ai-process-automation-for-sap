...
Usage:
    ...
    python scripts/deploy-frontend.py --pattern agent
"""
...
def run_command(
    ...
    """
    return subprocess.run(  # nosec B603 - command constructed from safe list  # nosemgrep: dangerous-subprocess-use-audit
        command,
...
def main() -> int:
    ...
    if args.pattern:
        ...
        pattern = tfvars.get("backend_pattern", "agent")
