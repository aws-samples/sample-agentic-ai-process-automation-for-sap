...
# nosemgrep: aws-s3-bucket-versioning-not-enabled — deployment artifact bucket
...
# Manual deployment app (no Git integration) — deployed via deploy-frontend.py,
# which also sets environment variables at deploy time.
